...
const theme = createTheme({
  ...
  typography: {
    ...
    h1: { fontFamily: "var(--font-display), sans-serif", fontWeight: 600, letterSpacing: "-0.01em" },
    h2: { fontFamily: "var(--font-display), sans-serif", fontWeight: 600, letterSpacing: "-0.01em" },
